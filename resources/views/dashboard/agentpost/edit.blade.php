...
<main class="form-signin w-100 m-auto">
  <form action="/dashboard/agen/{{ $post->id }}" method="post">
    @method('put')
    @csrf

    <div class="form-floating mb-1">
      <input type="text" name="NAMAAGEN" class="form-control @error('NAMAAGEN') is-invalid @enderror"  id="NAMAAGEN" placeholder="name@example.com"  value="{{old('NAMAAGEN', $post->NAMAAGEN)}}">
    ...
    <div class="form-floating mb-1">
      <input type="text" name="NOIZIN" class="form-control @error('NOIZIN') is-invalid @enderror"  id="NOIZIN" placeholder="name@example.com"  value="{{old('NOIZIN', $post->NOIZIN)}}">
    ...
    <div class="form-floating mb-1">
      <input type="text" name="PJ" class="form-control @error('PJ') is-invalid @enderror"  id="PJ" placeholder="name@example.com"  value="{{old('PJ', $post->PJ)}}">
